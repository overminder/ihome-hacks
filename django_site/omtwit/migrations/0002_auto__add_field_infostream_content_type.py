...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfoStream.content_type'
        db.add_column('omtwit_infostream', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['contenttypes.ContentType']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InfoStream.content_type'
        db.delete_column('omtwit_infostream', 'content_type_id')
    ...
    models = {
        ...
        'omtwit.omuser': {
            ...
            'following': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'followers'", 'blank': 'True', 'to': "orm['omtwit.OmUser']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
