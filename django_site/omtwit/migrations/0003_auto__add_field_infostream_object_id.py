...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfoStream.object_id'
        db.add_column('omtwit_infostream', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InfoStream.object_id'
        db.delete_column('omtwit_infostream', 'object_id')
