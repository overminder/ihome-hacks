 ...
 * @protected
 */
cBackbone.models.Collection.prototype.model_ = cBackbone.models.Model;
...
cBackbone.models.Collection.prototype.sort = function(options) {
    ...
    goog.array.stableSort(this.models_, this.comparator_);
    if (!options["silent"])
...
cBackbone.models.Collection.prototype.prepareModelInternal = function(
    ...
    if (!(model instanceof cBackbone.models.Model)) {
        ...
        model = new this.model_(attrs, {collection: this});
...
cBackbone.models.Collection.prototype.addInternal = function(
    ...
    if (goog.isDefAndNotNull(options["at"])) {
        ...
        goog.array.binaryInsert(this.models_, model, this.comparator_);
    }
    else {
...
cBackbone.models.Collection.prototype.removeInternal = function(
    ...
    if (this.comparator_)
        goog.array.binaryRemove(this.models_, model, this.comparator_);
    else
